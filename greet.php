...
<section class="greet_section">
  <p class="emphasis serif"> <!-- 강조하다 -->
    정보화 시대에 <b class="point">빠른 정보를 원하는 우리들에게</b> 인터넷은 <br>
    하나의 <b class="point">거대한 생활공간</b>이 되었습니다.
  </p>
  ...
  <figure>
    ...
    <div><img src="./img/sub1/about-02.jpg" al=""></div>
  </figure>

  <p class="emphasis serif">
    그만큼 홈페이지는 <b class="point">기업활동의 중요한 요소</b>가 되었고 매출과 <br>
    <b class="point">이미지 향상의 가장 영향력</b>이있는 매체가 되었습니다.
  </p>

  <p>
    홈페이지의 중요성을 잘 아는 선샤인은 고객의 성공적인 홈페이지 제작을 위하여 <br>
    진정한 동반자로서 함께 하고 싶습니다. <br>

    <br>선샤인은 기업홍보형, 쇼핑몰, 웹프로그래밍, 웹솔루션, 전자카달로그, 이미지촬영편집, 웹프로모션전문 에이전시로써 <br>
